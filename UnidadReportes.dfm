object Reportes: TReportes
  ...
  object RUsuarios: TQuickRep
    ...
    object QRExprMemo1: TQRExprMemo
      ...
      Lines.Strings = (
        ...
        'Código Postal:{Usuarios.CodigoPostal}'
  ...
  object RArbol: TQuickRep
    ...
    object QRSubDetail1: TQRSubDetail
      ...
      object QRExprMemo3: TQRExprMemo
        ...
        Color = clWhite
        Lines.Strings = (
          'Garantía: Nº: {Garantias.Ngarantia}  Fecha: {Garantias.fecha}')
        Transparent = False
        WordWrap = True
        FontSize = 10
      end
    ...
    object QRSubDetail2: TQRSubDetail
      ...
      object QRExprMemo2: TQRExprMemo
        ...
        Lines.Strings = (
            ...
            'Registro :  Nº: {Registro.codigo}   Equipo: {Registro.Codvigia} ' +
    ...
    object QRSubDetail3: TQRSubDetail
      ...
      object QRExprMemo4: TQRExprMemo
        ...
        Lines.Strings = (
            ...
            'Control: Nº: {Controles.codigo} - Fecha: {Controles.Fecha} - Pró' +
            'ximo Control: {Controles.Proxctrl}'
          
            'Sensor Temperatura Aceite:{Controles.stemaceite} - Sensor Presió' +
          ...
          'Sensor Temperatura Cilindro: {Controles.stemcilind}'
            ...
            'Presión Aire Turbina: {Controles.preairetur} - Tablero: {Control' +
            'es.tablero}'
          
            'Instalación Eléctrica: {Controles.instelectr} - Funcionamiento: ' +
    ...
    object QRSubDetail4: TQRSubDetail
      ...
      object QRExprMemo6: TQRExprMemo
        ...
        Lines.Strings = (
            ...
            'Control: Nº: {Cosechadoras.codigo} - Fecha: {cosechadoras.Fecha}' +
            ' - Próximo Control: {cosechadoras.Proxctrl}'
          'Tablero:{cosechadoras.tablero} - Sirena: {cosechadoras.sirena}'
          
            'Derivación 1: Rotor: {cosechadoras.Rotor1} - Trasductor: {cosech' +
            'adoras.Trasductor1} - Alimentación: {cosechadoras.Alimentación}'
          
            '              Masa: {cosechadoras.Masa1} - Señal: {cosechadoras.' +
            'Señal1}'
          
            'Derivación 2: Rotor: {cosechadoras.Rotor2} - Trasductor: {cosech' +
            'adoras.Trasductor2} - Alimentación: {cosechadoras.Alimentación}'
          
            '              Masa: {cosechadoras.Masa2} - Señal: {cosechadoras.' +
            'Señal2}'
          
            'Derivación 3: Rotor: {cosechadoras.Rotor3} - Trasductor: {cosech' +
            'adoras.Trasductor3} - Alimentación: {cosechadoras.Alimentación}'
          
            '              Masa: {cosechadoras.Masa3} - Señal: {cosechadoras.' +
            'Señal3}'
          
            'Derivación 4: Rotor: {cosechadoras.Rotor4} - Trasductor: {cosech' +
            'adoras.Trasductor4} - Alimentación: {cosechadoras.Alimentación}'
          
            '              Masa: {cosechadoras.Masa4} - Señal: {cosechadoras.' +
            'Señal4}'
          
            'Derivación 5: Rotor: {cosechadoras.Rotor5} - Trasductor: {cosech' +
            'adoras.Trasductor5} - Alimentación: {cosechadoras.Alimentación}'
          
            '              Masa: {cosechadoras.Masa5} - Señal: {cosechadoras.' +
            'Señal5}'
  ...
  object RArticulo: TQuickRep
    ...
    object QRExprMemo5: TQRExprMemo
      ...
      Font.Style = []
      Lines.Strings = (
        'Descripción: {Articulos.descripart}'
        ''
        'Precio Unitario:{Articulos.Punit}'
        'Bonificación: {Articulos.bonifica}'
        ...
        'M: Protector Motor; N: Protector Neumáticos;'
    ...
    object DetailBand3: TQRBand
      ...
      object QRExpr9: TQRExpr
        ...
        Expression = 
          ...
          'oequipo = '#39'N'#39','#39'Protector Neumáticos'#39',IF(Articulos.Tipoequipo = '#39 +
